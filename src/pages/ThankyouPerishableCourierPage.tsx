...
const ThankyouPerishableCourierPage: FC = () => {
  return (
    <>
      <TopHeaderOne />
      <HeaderOne />
            ...
            <div className='col-lg-8'>
              <div className='bg-white border border-neutral-200 tw-rounded-3xl tw-p-8 tw-p-lg-12 text-center shadow-sm'>
                ...
                <p className='text-neutral-600 tw-text-lg tw-mt-5 mb-0'>
                  Thank you for your perishable shipment enquiry. Please check your email for further instructions. Our
                  team will reach out shortly regarding your request.
                </p>
...
export default ThankyouPerishableCourierPage;
